    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                ...
                hover:scale-102 active:scale-95 transition cursor-pointer' onClick={()=>navigate('/ai')}>Start Creating now</button>
                <button className='bg-white px-10 py-3 rounded-lg border
                border-gray-300 hover:scale-102 active:scale-95 transition'>Watch Demo</button>
            </div>
